...
**Tuntuma ehdotuksessa.** Työsarjalle voi antaa tuntuman rivin RPE-painikkeesta samalla asteikolla kuin lämmittelylle (valinta on vapaaehtoinen, näkyy lukuna RPE-painikkeessa ja poistuu napauttamalla valittua lukua uudelleen; valinnan jälkeen rivi sulkeutuu itsestään). Tuntuma tulkitaan RIR-arvoksi (reps in reserve, varastoon jääneet toistot) ja lisätään toistoihin Epley-arviossa; ehdotus on paino, jolla tavoitetoistot tuntuisivat Työläältä (RIR 2). Kun viime kerran sarjalle on kirjattu tuntuma, ehdotus lasketaan tällä kaavalla ilman edellä mainittuja nosto- ja kevennyshaaroja ja niiden rajoja:
